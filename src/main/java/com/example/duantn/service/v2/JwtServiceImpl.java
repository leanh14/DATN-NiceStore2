...
public class JwtServiceImpl implements JwtService {
    ...
    public JwtServiceImpl(@Value("${jwt.secret}") String secret, @Value("${jwt.expiration}") int expiration) {
        this.secret = secret;
    ...
    private String createToken(Map<String, Object> claims, String userName, int days) {
        return Jwts.builder()
            ...
            .setExpiration(new Date(System.currentTimeMillis() + (long) expiration * days))
