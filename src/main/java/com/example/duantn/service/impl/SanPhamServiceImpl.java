...
//
//    @Override
//    public List<SanPham> findByCondition(SanPham entity) {
//        return null;
//    }
...
//    @Override
//    public Page<SanPham> findPage(SanPham entity, Pageable pageable) {
//        return null;
//    }
    ...
    public Boolean kiemTraTrungTenKhong(String tenMoi, String tenCu){
        List<SanPham> dsSanPham = (List<SanPham>) this.layDanhSach(Pageable.unpaged());
