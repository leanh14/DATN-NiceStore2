                        ...
                        <c:forEach items="${dsSanPham}" var="sanPhamCT">
                            ...
                            <figure class="product-media">
                                <a href="product.html">
                                    ...
                                    <img src="https://static.nike.com/a/images/t_PDP_1728_v1/f_auto,q_auto:eco/f7c941ab-7e44-4819-9483-adb9cd082787/court-vision-low-next-nature-shoes-p3CnbT.png" alt="Product image" class="product-image-hover">
                                </a>
                            ...
                            <div class="product-body">
                                <h3 class="product-title"><a href="product.html">${sanPhamCT.sanPham.ten}</a></h3><!-- End .product-title -->
