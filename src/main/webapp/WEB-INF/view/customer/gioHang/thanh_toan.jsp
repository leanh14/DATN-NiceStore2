                ...
                <div class="container">
                    <div class="checkout-discount">
                        <form action="#">
                            ...
                            <label for="checkout-discount-input" class="text-truncate">Nhập mã giảm giá tại đây<span></span></label>
                        </form>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <sf:input path="hoVaTen" class="form-control"  />
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <sf:input path="soDT" class="form-control"  />
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        ...
                                        <sf:errors path="phuong_xa" cssClass="text-danger" />
                                    </div><!-- End .col-sm-6 -->
                                </div><!-- End .row -->
                                    ...
                                    <table class="table table-summary">
                                        ...
                                        <c:forEach items="${dsSanPham}" var="sanPhamTrongGio">
                                            <tr >
                                                ...
                                                <td style="padding-left: 20px;"><a href="#">${sanPhamTrongGio.sanPham.ten}</a></td>
                                                <td>${sanPhamTrongGio.soLuong}</td>
                                                <td>${sanPhamTrongGio.kichCo.ten}</td>
                                                <td>${sanPhamTrongGio.mauSac.ten}</td>
                                                <td>
                                                    <fmt:formatNumber type = "number"
                                                                      maxFractionDigits = "0" value = "${sanPhamTrongGio.gia*sanPhamTrongGio.soLuong}" />
